...
Written by `kb.py lint` 2026-09-20 04:43. Marketing and low-value items skip the queue. Skim the titles; if one deserves a full note, run `python _pipeline\kb.py rescue --id=<id>`.
